                                  ...
                                  <div>
                                    <div id="gnb" style="background-color:black;">
                                      <div id= "gnbmn" style="overflow: visible; opacity: 1;">
                                        <ul class = "depth1">
                                          <li>
                                            <a href="https://localhost/view/1.php" style="text-indent: 0px;">명소소개</a>
                                          </li>
                                          <li>
                                            <a href="https://localhost/food/1.php" style="text-indent: 0px;">음식소개</a>
                                          </li>
                                          <li>
                                            <a href="https://localhost/festival/1.php" style="text-indent: 0px;">서울축제</a>
                                          </li>
                                          <li>
                                            <a href="https://localhost/nightscape/1.php" style="text-indent: 0px;">야경명소</a>
                                          </li>
                                          <li>
                                            <a href="https://localhost/traditional/1.php" style="text-indent: 0px;">전통행사</a>
                                          </li>
                                           <li>
                                            <a href="https://localhost/after/1.php" style="text-indent: 0px;">여행후기</a>
                                            </li>
                                        </ul>
  ...
  <h3>서울축제</h3>
    <div class="col-md-2" style="min-width:300px; padding-top:20px;">
      <ul class="nav nav-pills nav-stacked">
        <li class="active"><a href="https://localhost/festival/1.php">서울축제</a></li>
        <li><a href="https://localhost/festival/1.php">(4월)여의도 벚꽃축제</a></li>
        <li><a href="https://localhost/festival/2.php">(5월)청계천 연등축제</a></li>
        <li><a href="https://localhost/festival/3.php">(7월)신촌 물총축제</a></li>
        <li><a href="https://localhost/festival/4.php">(10월)여의도 불꽃축제</a></li>
        <li><a href="https://localhost/festival/5.php">(10월)억새축제</a></li>
        <li><a href="https://localhost/festival/6.php">(10월)이태원 할로윈축제</a></li>
        <li><a href="https://localhost/festival/7.php">(11월)청계천 빛초롱축제</a></li>
      </ul>
    </div>
